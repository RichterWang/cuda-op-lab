// Performance profiling for naive matrix multiplication
// Usage: ./perf_naive <matrix_size>
// Example: perf stat -e cache-misses,cache-references ./perf_naive 1024
...
int main(int argc, char** argv) {
    ...
    cout << "=== Naive Algorithm Performance Test ===" << endl;
    cout << "Matrix size: " << size << "x" << size << endl;
    cout << "Algorithm: Triple-loop (i-j-k)" << endl;
    cout << endl;
    ...
    for (int i = 0; i < 3; ++i) {
        cpu_cache::matmul_naive(A.data(), B.data(), C.data(), size, size, size);
    }
    ...
    cout << endl;
    cout << "Note: Use with 'perf stat' for cache analysis" << endl;
    cout << "Example: perf stat -e cache-misses,L1-dcache-load-misses " << argv[0] << " " << size << endl;
